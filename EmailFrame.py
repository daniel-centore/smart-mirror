...
class EmailFrame(Frame):
    ...
    def __init__(self, title, master=None):
        ...
        Label(self, textvariable=self.emailLabel, font=("SFNS Display", 13), bg="black", foreground="white", anchor=E).place(y=0, x=0)
    ...
    def addEmail(self, sender, subject, body):
        ...
        tbox = Text(self, height=2, width=30, bg="black", font=("SFNS Display", 11), foreground="white", bd=0, highlightthickness=0, wrap=WORD)
